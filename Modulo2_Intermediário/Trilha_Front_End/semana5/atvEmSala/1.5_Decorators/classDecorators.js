...
var Aviao = function () {
    ...
    var _classThis;
    var Aviao = _classThis = /** @class */ (function () {
        function Aviao_1(modelo, capacidade) {
            this.modelo = modelo;
            this.capacidade = capacidade;
            this.modelo = modelo;
            this.capacidade = capacidade;
        }
        Aviao_1.prototype.voar = function () {
            console.log('Voando...');
        };
        ;
        Aviao_1.prototype.aterrissar = function () {
            console.log('Aterrissando...');
        };
        ;
        return Aviao_1;
    }());
    __setFunctionName(_classThis, "Aviao");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        Aviao = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Aviao = _classThis;
}();
//decorator não é chamado quando a classe é instanciada
var aviao = new Aviao('Boeing 777', 500);
